...
Lorsque l'utilisateur choisi un classement, le serveur reçoit une requête GET/nom_classement. Il renvoie alors la liste dans l'ordre des 5 premiers pays pour ce classement. 
...
Lorsque l'utilisateur décide de regarder un classement, il choisit dans un menu déroulant le classement qu'il veut voir, par exemple les 5 pays d'Asie les plus peuplés. Une fois qu'il a sélectionné le Top 5, celui-ci s'affiche directement.